...
import icondiscord from "../images/ServerSeparator.png";
import impo from "../data/servers.json";
...
export default function () {
    return (
        ...
        <div>
            ...
            <img src={icondiscord} width="47" alt="Search icon" />
